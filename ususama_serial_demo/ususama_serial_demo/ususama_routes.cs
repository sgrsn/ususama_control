...
namespace ususama_routes
{
  ...
  public class UsusamaRoutes
  {
    ...
    public UsusamaRoutes()
    {
      ...
      move_seq_1.Add(new Pose2D(1050f / 1000, 100f / 1000, 1.57f, CleanState.Move)); // 少し吹き飛ばす
      move_seq_1.Add(new Pose2D(1200f / 1000, 100f / 1000, 1.57f, CleanState.Move)); // 水にあたらないようスライド
      move_seq_1.Add(new Pose2D(1200f / 1000, 700f / 1000, 1.57f, CleanState.Move)); // ゴミ箱に入れる
      ...
      move_seq_3.Add(new Pose2D(1200f / 1000, 450f / 1000, 1.57f, CleanState.Move)); // 後ろに下がる
      move_seq_3.Add(new Pose2D(1200f / 1000, 450f / 1000, 2.50f, CleanState.Move)); // 紙コップに向きを変更
      move_seq_3.Add(new Pose2D(1030f / 1000, 680f / 1000, 2.50f, CleanState.Move)); // 紙コップ回収
      move_seq_3.Add(new Pose2D(1050f / 1000, 650f / 1000, 1.57f, CleanState.Move)); // 紙コップ移動
      move_seq_3.Add(new Pose2D(1200f / 1000, 650f / 1000, 1.57f, CleanState.Move)); // 紙コップ横移動
      move_seq_3.Add(new Pose2D(1200f / 1000, 700f / 1000, 1.57f, CleanState.Move)); // 紙コップゴミ箱に入れる
      move_seq_3.Add(new Pose2D(1200f / 1000, 450f / 1000, 1.57f, CleanState.Move)); // 戻る

      move_seq_4.Add(new Pose2D(1200f / 1000, 450f / 1000, 1.57f, CleanState.Move)); // 何もしない
