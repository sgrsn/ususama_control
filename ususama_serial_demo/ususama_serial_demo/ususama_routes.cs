...
namespace ususama_routes
{
  ...
  public class UsusamaRoutes
  {
    ...
    public UsusamaRoutes()
    {
      ...
      move_seq_1.Add(new Pose2D(1150f / 1000, 000f / 1000, 0.00f, CleanState.Move)); // まっすぐ進む 芯回収
      move_seq_1.Add(new Pose2D(1150f / 1000, 000f / 1000, 1.57f, CleanState.Move)); // 90deg 旋回
      move_seq_1.Add(new Pose2D(1150f / 1000, 850f / 1000, 1.57f, CleanState.Move)); // ゴミ箱に入れる
      move_seq_1.Add(new Pose2D(1150f / 1000, 000f / 1000, 1.57f, CleanState.Move)); // 戻ってくる
      ...
      move_seq_1.Add(new Pose2D(1300f / 1000, 000f / 1000, 1.57f, CleanState.Move)); // スライド

      // seq3: 便器前の床、便器を掃除するタスク
      move_seq_3.Add(new Pose2D(1300f / 1000, 450f / 1000, 1.57f, CleanState.Move)); // トイレの前に移動
      move_seq_3.Add(new Pose2D(1300f / 1000, 450f / 1000, 3.14f, CleanState.Move)); // トイレ正面となるように旋回

      // ここで床掃除、便器掃除

      // seq4: ゴミ2(仮に紙コップとする)をゴミ箱に入れるタスク
      move_seq_4.Add(new Pose2D(1200f / 1000, 450f / 1000, 3.14f, CleanState.Move)); // 近づく
      move_seq_4.Add(new Pose2D(1200f / 1000, 450f / 1000, 2.30f, CleanState.Move)); // 紙コップに向きを変更
      move_seq_4.Add(new Pose2D( 950f / 1000, 780f / 1000, 2.30f, CleanState.Move)); // 紙コップ回収
      move_seq_4.Add(new Pose2D( 950f / 1000, 780f / 1000, 1.57f, CleanState.Move)); // 姿勢をゴミ箱に垂直に変更
      move_seq_4.Add(new Pose2D(1200f / 1000, 550f / 1000, 1.57f, CleanState.Move)); // 紙コップ横移動
